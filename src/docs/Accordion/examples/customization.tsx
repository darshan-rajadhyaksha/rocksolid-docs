...
export default function Example() {
  return (
    <div class="max-w-md space-y-2">
      ...
      >
        <AccordionSummary
          class="px-3 py-2 font-semibold text-neutral-900 dark:text-neutral-100"
        >
          What is photosynthesis?
        </AccordionSummary>
        <AccordionDetails
          class="border-t border-neutral-200 px-3 text-sm leading-6 text-neutral-600 dark:border-neutral-800 dark:text-neutral-400 duration-800"
        >
      ...
      >
        <AccordionSummary
          class="px-3 py-2 font-medium text-blue-900 dark:text-blue-100"
        >
          How does gravity work?
        </AccordionSummary>
        <AccordionDetails
          class="border-t border-blue-200 px-3 text-sm leading-6 text-blue-800 dark:border-blue-900 dark:text-blue-200"
        >
      ...
      >
        <AccordionSummary
          class="px-3 py-2 text-lg font-semibold text-purple-900 dark:text-purple-100"
        >
          What is a black hole?
        </AccordionSummary>
        <AccordionDetails
          class="border-t border-purple-200 px-3 text-sm leading-7 text-purple-800 dark:border-purple-900 dark:text-purple-200"
        >
